...
window.AIRSHIP_KPI_THRESHOLDS = {
  ...
  "items": [
    ...
    { "key": "direct_response_rate_min", "label": "Click rate floor", "group": "push", "unit": "%", "default": 0.5, "hint": "Click rate (direct responses / sends) < X% in the current window -> alert (tracking-health). Shared default for both platforms: set direct_response_rate_min_ios / _android to guard them separately" },
    { "key": "direct_response_rate_min_ios", "label": "Click rate floor — iOS", "group": "push", "unit": "%", "inherits": "direct_response_rate_min", "hint": "iOS-only click-rate floor. Unset = inherit direct_response_rate_min. Android medians run above iOS in every vertical of the benchmark set, so one shared floor is not the same guard on the two platforms" },
    { "key": "direct_response_rate_min_android", "label": "Click rate floor — Android", "group": "push", "unit": "%", "inherits": "direct_response_rate_min", "hint": "Android-only click-rate floor. Unset = inherit direct_response_rate_min" },
    { "key": "direct_response_collapse_pct", "label": "Click rate collapse", "group": "push", "unit": "%", "default": 40, "hint": "30d drop of the click rate >= X% -> likely tracking/SDK issue. Shared default for both platforms: set direct_response_collapse_pct_ios / _android to guard them separately" },
    { "key": "direct_response_collapse_pct_ios", "label": "Click rate collapse — iOS", "group": "push", "unit": "%", "inherits": "direct_response_collapse_pct", "hint": "iOS-only collapse guard. Unset = inherit direct_response_collapse_pct. An SDK or deep-link regression ships per platform, so the guard that catches it belongs per platform" },
    { "key": "direct_response_collapse_pct_android", "label": "Click rate collapse — Android", "group": "push", "unit": "%", "inherits": "direct_response_collapse_pct", "hint": "Android-only collapse guard. Unset = inherit direct_response_collapse_pct" },
