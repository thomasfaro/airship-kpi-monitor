...
window.AIRSHIP_KPI_THRESHOLDS = {
  ...
  "items": [
    { "key": "app_opens_drop_pct", "label": "App opens drop", "group": "app", "unit": "%", "default": 20, "hint": "Drop > X% vs prior 7d (per OS) -> alert" },
    ...
    { "key": "push_sends_drop_pct", "label": "Push sends drop", "group": "push", "unit": "%", "default": 50, "hint": "Drop > X% (per OS) -> alert" },
    ...
    { "key": "email_sends_drop_pct", "label": "Email sends drop", "group": "email", "unit": "%", "default": 20, "hint": "Drop > X% -> alert" },
    ...
    { "key": "email_delay_rate_max", "label": "Email delay ceiling", "group": "email", "unit": "%", "default": 10, "hint": "Daily delay / delivery > X% -> alert" },

    { "key": "web_sends_drop_pct", "label": "Web push sends drop", "group": "web", "unit": "%", "default": 30, "hint": "Drop > X% -> alert (only if web devices > 0)" },
    { "key": "web_sends_rise_pct", "label": "Web push sends spike", "group": "web", "unit": "%", "default": 100, "hint": "Rise > X% -> alert (unexpected spike)" },

    { "key": "sms_sends_drop_pct", "label": "SMS sends drop", "group": "sms", "unit": "%", "default": 30, "hint": "WoW drop > X% -> alert (only if SMS channel active)" },
